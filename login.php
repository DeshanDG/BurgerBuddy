...
<body>
   ...
   <i class='fa fa-times' id="exit" ></i>
	...
	<div class="wrapper">
		...
		<h2>Log in</h2>
		<p>Log in with following options</p>
		<label for = "">E-mail</label>
		<input type="email" id="txtLogEmail" name="txtLogEmail">
		<label for = "">Password</label>
		<input type="password" id="txtLogEmail" name="txtLogPassword">
		<button name="btnlogin" id="btnlogin">Log in</button>
		<p>
			Doesn't have an account ? <a href="Signup.php">
			Sign Up</a>
		</p>
		</form>
	</div>
